                ...
                >
                    ...
                    <div className="flex items-center justify-between px-4 py-3.5 bg-white border-b border-[#EEF2F6]">
                        <div className="flex items-center gap-2.5">
                            ...
                            <div>
                                <p className="text-sm font-semibold text-[#1E293B] leading-none">PharmAI Assistant</p>
                    ...
                    <div className="flex-1 overflow-y-auto p-4 space-y-3">
                        {messages.map((msg, idx) => (
                            ...
                            >
                                <div className={`max-w-[82%] rounded-2xl px-4 py-2.5 text-sm leading-relaxed ${msg.role === "bot"
